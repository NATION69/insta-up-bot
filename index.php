<?php
error_reporting(0);
function swap($instid,$sleep){
sleep($sleep);
$url = 'http://178.62.206.135/instaupcoinsbot.php?uid='.$instid.'&submit=submit';
...
$result = curl_exec($ch);
if(strpos($result,'"status":"Successful","message":"Sucess!","return":{"coins":null')){
return 'blocked';
}elseif(strpos($result,'"status":"Successful","message":"Sucess!"')){
return 'true';
} else {
return 'false';
}
